...
export default function Dashboard() {
	...
	const changesItems = [
		...
		{
			title: "Channels",
			details: ["Added new channel: TikTok", "Removed channel: Pinterest"],
		},
		{
			title: "Team",
			details: [],
							...
							>
								<svg
									className={`w-3 h-3 text-gray-500 transform transition-transform ${
										groupVisibility[group.title] ? "rotate-180" : ""
									}`}
									viewBox="0 0 24 24"
									fill="none"
									stroke="currentColor"
								...
								group.items.map((item, itemIndex) => (
									...
									<div
										...
										className={`flex items-center px-4 py-2 hover:bg-gray-50 group cursor-pointer ${
											selectedItem === item && selectedGroup === group.title
												? "bg-gray-50"
												: ""
										}`}
