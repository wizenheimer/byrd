// src/app/(compliance)/terms/page.tsx
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-8">
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="text-gray-600">
                    By accessing or using byrd&apos;s services, you agree to be
              ...
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="text-gray-600">
                    byrd provides a software-as-a-service platform for
                    competitive intelligence gathering and analysis. The
                    specific features and functionality may be modified,
                    updated, or removed at any time at our discretion.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="text-gray-600 mb-4">
                    To access the service, you must create an account. You agree
                    to:
                  </p>
              ...
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    ...
                    <li>
                      Use the service in a way that could damage or overburden
                      our systems
                    </li>
                  </ul>
                </div>
              ...
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="text-gray-600">
                    The service, including all related features, functionality,
                    and content, is owned by byrd and protected by intellectual
                    property laws. Users retain ownership of their data but
                    grant us necessary licenses to provide the service.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  ...
                  <ul className="list-disc list-inside text-gray-600 space-y-2">
                    ...
                    <li>
                      The accuracy or completeness of any data or analysis
                    </li>
              ...
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="text-gray-600">
                    To the maximum extent permitted by law, byrd shall not be
              ...
              <section>
                ...
                <div className="pl-4 border-l-2 border-gray-200">
                  <p className="text-gray-600">
                    ...
                    through the service. Continued use of the service after such
