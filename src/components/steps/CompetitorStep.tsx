...
import { competitorFormSchema, type CompetitorFormData } from "@/app/_types/onboarding";
...
export default function CompetitorStep({ formData, setFormData, onNext }: CompetitorStepProps) {
