...
const steps: Record<number, Step> = {
  1: { title: "Your Market, Your Rules", description: "Pick your targets. Add up to 5 competitors.", image: "/onboarding/first.png" },
  2: { title: "Measure What Matters", description: "Choose your signals. Cut through the noise.", image: "/onboarding/second.png" },
  3: { title: "Never Miss A Beat", description: "Your competitors are everywhere. So are we.", image: "/onboarding/third.png" },
  4: { title: "Build Your War Room", description: "Business is a team sport. Bring in your heavy hitters.", image: "/onboarding/four.png" },
  5: { title: "You're almost there", description: "Quick auth, then let's get started.", image: "/onboarding/five.png" },
}

const channelCards: ChannelCard[] = [
  { id: "inbox", icon: Inbox, title: "Inbox", description: "Monitor the direct line to their customers" },
  { id: "social", icon: Share2, title: "Social", description: "Follow their social playbook as it unfolds" },
  { id: "mentions", icon: Megaphone, title: "Mentions", description: "Beat them to their own announcement" },
  { id: "content", icon: Rss, title: "Content", description: "Watch their messaging evolve, post by post" },
]
...
const MultiStepOnboarding = () => {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <FeaturesStep formData={formData} setFormData={setFormData} onNext={handleNext} />
      case 3:
        return <ChannelsStep formData={formData} setFormData={setFormData} onNext={handleNext} cards={channelCards} />
      case 4:
        return <TeamStep formData={formData} setFormData={setFormData} onNext={handleNext} />
      case 5:
