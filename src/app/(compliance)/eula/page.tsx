      ...
      <main className="flex-grow px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center mb-8">
            <h1 className="text-4xl font-bold text-black">End User License Agreement</h1>
          ...
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section>
              <p className="text-gray-600">
                ...
                ("User", "you", or "your") and ByrdLabs, Inc. ("Company", "we", "us", or "our")
                for the use of our competitive intelligence software-as-a-service platform
                ("Service").
              </p>
            </section>
            ...
            <section>
              ...
              <div className="pl-4 border-l-2 border-gray-200">
                <p className="text-gray-600">
                  Subject to the terms of this Agreement and payment of applicable fees, we grant
            ...
            <section>
              ...
              <div className="pl-4 border-l-2 border-gray-200">
                <p className="text-gray-600">
                  The Service, including all intellectual property rights, belongs to us. You
                  retain ownership of any data you input into the Service. You grant us a
            ...
            <section>
              <h2 className="text-2xl font-bold mt-8 mb-4">4. Confidentiality</h2>
              <div className="pl-4 border-l-2 border-gray-200">
                <p className="text-gray-600">
                  You agree to maintain the confidentiality of any non-public features,
                  functionality, or information about the Service. This includes beta features
                  and pre-release information.
                </p>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-bold mt-8 mb-4">5. Term and Termination</h2>
              <div className="pl-4 border-l-2 border-gray-200">
                <p className="text-gray-600">
                  This Agreement remains in effect until terminated. We may suspend or
            ...
            <section>
              <h2 className="text-2xl font-bold mt-8 mb-4">6. Warranty Disclaimer</h2>
              <div className="pl-4 border-l-2 border-gray-200">
                <p className="text-gray-600">
            ...
            <section>
              ...
              <div className="pl-4 border-l-2 border-gray-200">
                <p className="text-gray-600">
                  ...
                  you of material changes. Continued use of the Service constitutes
            ...
            <section>
              ...
              <div className="pl-4 border-l-2 border-gray-200">
                <p className="text-gray-600">
                  This Agreement is governed by the laws of soverign republic state of India, without regard
