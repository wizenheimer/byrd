...
type AIService interface {
	...
	AnalyzeContentDifferences(ctx context.Context, version1, version2 string, profile string) (*models.DynamicChanges, error)

    // AnalyzeVisualDifferences analyzes the visual differences between two screenshots
	AnalyzeVisualDifferences(ctx context.Context, version1, version2 image.Image, profile string) (*models.DynamicChanges, error)
