...
type CompetitorService interface {
	...
	// or otherwise.
	CreateCompetitor(ctx context.Context, workspaceID uuid.UUID, competitorReq api.CreateCompetitorRequest) (api.CreateWorkspaceCompetitorResponse, error)
	...
	GetCompetitor(ctx context.Context, workspaceID, competitorID uuid.UUID, pagePaginationParam api.PaginationParams) (api.GetWorkspaceCompetitorResponse, error)
	...
	RemoveCompetitors(ctx context.Context, workspaceID uuid.UUID, competitorIDs []uuid.UUID) error
	...
	AddPagesToCompetitor(ctx context.Context, competitorID uuid.UUID, pageReq []api.CreatePageRequest) ([]models.Page, error)
	...
	GetCompetitorPage(ctx context.Context, competitorID, pageID uuid.UUID, pageHistoryPaginationParam api.PaginationParams) (api.GetPageResponse, error)
	...
	UpdatePage(ctx context.Context, competitorID, pageID uuid.UUID, pageReq api.UpdatePageRequest) (models.Page, error)
	...
	RemovePagesFromCompetitor(ctx context.Context, competitorID uuid.UUID, pageID []uuid.UUID) error
	...
	ListCompetitorPages(ctx context.Context, competitorID uuid.UUID) ([]models.Page, error)
}
