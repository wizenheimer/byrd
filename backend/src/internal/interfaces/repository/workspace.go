...
type WorkspaceRepository interface {
	...
	CreateWorkspace(ctx context.Context, workspaceName, billingEmail string) (models.Workspace, err.Error)

	// GetWorkspace gets a workspace by its ID
	// This is used to get the workspace details
	GetWorkspaces(ctx context.Context, workspaceID []uuid.UUID) ([]models.Workspace, err.Error)
	...
	UpdateWorkspaceBillingEmail(ctx context.Context, workspaceID uuid.UUID, billingEmail string) err.Error
	...
	UpdateWorkspace(ctx context.Context, workspaceID uuid.UUID, workspaceReq models.WorkspaceProps) err.Error
}
