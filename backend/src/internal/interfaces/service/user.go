...
type UserService interface {
	...
	CreateWorkspaceOwner(ctx context.Context, clerk *clerk.User, workspaceID uuid.UUID) (*models.User, err.Error)
	...
	AddUserToWorkspace(ctx context.Context, workspaceID uuid.UUID, invitedUsers []api.InviteUserToWorkspaceRequest) ([]api.CreateWorkspaceUserResponse, err.Error)
	...
	GetWorkspaceUser(ctx context.Context, clerk *clerk.User, workspaceID uuid.UUID) (models.WorkspaceUser, err.Error)
	...
	GetWorkspaceUserByID(ctx context.Context, userID, workspaceID uuid.UUID) (models.WorkspaceUser, err.Error)
	...
	ListUserWorkspaces(ctx context.Context, clerk *clerk.User) ([]uuid.UUID, err.Error)
	...
	UpdateWorkspaceUserRole(ctx context.Context, userID, workspaceID uuid.UUID, role models.UserWorkspaceRole) (models.WorkspaceUser, err.Error)

	UpdateWorkspaceUserStatus(ctx context.Context, userID, workspaceID uuid.UUID, status models.UserWorkspaceStatus) err.Error
	...
	RemoveWorkspaceUsers(ctx context.Context, userIDs []uuid.UUID, workspaceID uuid.UUID) err.Error
	...
	SyncUser(ctx context.Context, clerk *clerk.User) err.Error
	...
	DeleteUser(ctx context.Context, clerk *clerk.User) err.Error
}
