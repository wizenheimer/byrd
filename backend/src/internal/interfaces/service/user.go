...
type UserService interface {
	...
	CreateWorkspaceOwner(ctx context.Context, clerk *clerk.User, workspaceID uuid.UUID) (*models.User, errs.Error)
	...
	AddUserToWorkspace(ctx context.Context, workspaceID uuid.UUID, invitedUsers []api.InviteUserToWorkspaceRequest) ([]api.CreateWorkspaceUserResponse, errs.Error)
	...
	GetWorkspaceUser(ctx context.Context, clerk *clerk.User, workspaceID uuid.UUID) (models.WorkspaceUser, errs.Error)
	...
	GetWorkspaceUserByID(ctx context.Context, userID, workspaceID uuid.UUID) (models.WorkspaceUser, errs.Error)
	...
	ListUserWorkspaces(ctx context.Context, clerk *clerk.User) ([]uuid.UUID, errs.Error)
	...
	UpdateWorkspaceUserRole(ctx context.Context, userID, workspaceID uuid.UUID, role models.UserWorkspaceRole) (models.WorkspaceUser, errs.Error)

	UpdateWorkspaceUserStatus(ctx context.Context, userID, workspaceID uuid.UUID, status models.UserWorkspaceStatus) errs.Error
	...
	RemoveWorkspaceUsers(ctx context.Context, userIDs []uuid.UUID, workspaceID uuid.UUID) errs.Error
	...
	SyncUser(ctx context.Context, clerk *clerk.User) errs.Error
	...
	DeleteUser(ctx context.Context, clerk *clerk.User) errs.Error
}
