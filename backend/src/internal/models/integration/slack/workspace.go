...
const (
	// SlackWorkspaceStatusPending represents the pending status of the slack workspace
	// This is the status when workspace is linked but channel and canvas are not set
	// This is the immediate outcome of linking a workspace
	SlackWorkspaceStatusPending SlackWorkspaceStatus = "pending"
